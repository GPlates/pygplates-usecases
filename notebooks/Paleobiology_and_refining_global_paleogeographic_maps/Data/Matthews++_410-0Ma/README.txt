...
Contact: kara.matthews@earth.ox.ac.uk


Supplementary Material

We provide a series of animations and the digital plate model files (including rotations and geometries). These files allow for the visualisation and/or manipulation of the late Paleozoic to present-day (410-0 Ma) global plate motion model presented in this study. 


#########################################
Animations:

Animation S1, mmc2.mov (10.1 MB) - a comparison of the current model (top panel) with the original Domeier and Torsvik (2014) (DT14) model (bottom panel) from 410-250 Ma, highlighting where the current model is different based on the modifications described in Section 2 of the main text. 

Animation S2, mmc3.mov (25.8 MB) - plate reconstruction from 410-0 Ma. 

Animation S3, mmc4.mov (25.7 MB) - absolute plate velocities from 410-0 Ma.
